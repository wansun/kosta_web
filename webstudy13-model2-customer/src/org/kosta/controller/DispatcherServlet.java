...
public class DispatcherServlet extends HttpServlet {
	...
	/*
	 * 클라이언트의 요청을 분석한다 ( command를 확인 )
	 * HandlerMapping을 이용해 실제 컨트롤러 구현체를 반환받고
	 * 실행시킨다. 이 떄 리턴되는 정보는 이동할 view url과 이동방식(forward or redirect)
	 * 리턴된 정보를 이용해 클라이언트에게 응답하도록
	 * 처리한다
	 * Exception 발생시 error.jsp로 응답하도록 처리하되
	 * 콘솔에 로그를 남긴다.
	 */
